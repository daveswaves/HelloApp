...
HelloApp/
 ├── app/
 │    ├── src/main/
 │    │         ├── java/com/daveswaves/helloapp/MainActivity.kt
...
```sh
# app/src/main/java/com/daveswaves/helloapp/MainActivity.kt
package com.daveswaves.helloapp
